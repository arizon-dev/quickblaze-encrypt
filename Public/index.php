...
<head>
    ...
    <meta name="description" content="An extremely simple, one-time view encrypted message system. Send anybody passwords, or secret messages on a one-time view basis.">
...
<body class="text-center">
    ...
    <script src="./assets/js/buttonCopyURL.js"></script>
