        ...
        <div class="main-form">
            <form onsubmit="return false;">
                ...
                <div id="form_confirmation">
                    ...
                    <button class="btn btn-primary submit-button" onclick="formValidateDisplay();">
                ...
                <div id="form_content" style="display:none">
                    ...
                    <div class="buttons-inline">
                        <button type="button" class="btn btn-primary submit-button" onclick="copyToClipboard('valuetextbox', 'snackbar_message')">
