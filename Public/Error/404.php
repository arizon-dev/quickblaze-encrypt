...
<body class="text-center">
    ...
    <main class="form-submit">
        <h1>404</h1>
        <h5 class="text-muted">This page does not exist. It was most likely removed!</h5>
        ...
        <p class="mt-5 mb-3 text-muted">
            ...
            <a href="https://github.com/axtonprice/quickblaze-encrypt/releases" class="text-muted no-decoration">{{version}}</a>
        </p>
    </main>
